...
if (empty($programmes)) {
    ...
    foreach ($programmes as $programme) {
        ...
        echo '<a class="btn-module-select" data-programme="' . htmlspecialchars($nomProgramme) . '" id="' . htmlspecialchars($programme["id_prog"]) . '">' . htmlspecialchars($programme['nom_programme']) . '</a>';
    }
}
?>
</div>
